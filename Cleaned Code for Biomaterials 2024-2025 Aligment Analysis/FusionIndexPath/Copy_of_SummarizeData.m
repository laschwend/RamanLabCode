...
load('fiberdata_NMJMuscleOnly2_widthsforextra.mat')
...
%dirLocation = "C:\Users\laSch\Dropbox (MIT)\Raman Lab\Laura Schwendeman\20240603 Alignment Experiment 7 - human tc twitch\40x pancakes\"
    ...
    conditionNames = {"RGECO_R3", "WT_R4", "WT_R4NDM"};
...
for conditionNum = 1:numConditions
    ...
    for rep = 1:numReps
        ...
        fileNameN = dirLocationN + "40x_fliped_D14_stain_" + conditionNames{conditionNum} + "_" + replicateKey(conditionNum, rep) + ".nd2-channel_0.png";
